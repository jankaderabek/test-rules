...
async function loadChangelogConfig(cwd, overrides) {
  ...
  if (!config.output) {
    ...
    config.output = config.output === true ? defaults.output : resolve(cwd, config.output);
  }
  if (!config.repo) {
...
export { getCurrentGitBranch as a, getCurrentGitTag as b, getCurrentGitRef as c, getGitRemoteURL as d, getGitDiff as e, parseGitCommit as f, getLastGitTag as g, getGithubReleaseByTag as h, getGithubChangelog as i, createGithubRelease as j, githubNewReleaseURL as k, listGithubReleases as l, generateMarkDown as m, parseChangelogMarkdown as n, loadChangelogConfig as o, parseCommits as p, formatReference as q, resolveGithubToken as r, syncGithubRelease as s, formatCompareChanges as t, updateGithubRelease as u, resolveRepoConfig as v, getRepoConfig as w };
